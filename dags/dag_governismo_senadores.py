...
def governismo_pipeline():
    ...
    def create_raw_new():
        pg.execute_query(f"""
            DROP TABLE IF EXISTS raw.raw_radar_governismo_senadores_new;
            CREATE TABLE raw.raw_radar_governismo_senadores_new AS
    ...
    def swap_raw():
        pg.execute_query("""
            DROP TABLE IF EXISTS raw.raw_radar_governismo_senadores;
            ALTER TABLE raw.raw_radar_governismo_senadores_new
            RENAME TO raw_radar_governismo_senadores;
        """)
