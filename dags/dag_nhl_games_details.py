...
# Imports do projeto
# -----------------------------
from include.nhl_extraction.endpoints import get_all_games_details_endpoint
...
def nhl_games_details():
    ...
    def extraction():
        ...
        games = get_data_from_db(connection_provider=lambda: db_hook.get_conn(), table=table_name, cols=['game_id'], bool_filter=('has_games_details', False))
