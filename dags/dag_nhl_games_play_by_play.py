...
# Imports do projeto
# -----------------------------
from include.nhl_extraction.endpoints import get_all_games_play_by_play_endpoint
...
def nhl_games_play_by_play():
    ...
    def extraction():
        ...
        games = get_data_from_db(connection_provider=lambda: db_hook.get_conn(), table=table_name, cols=['game_id'], bool_filter=('has_play_by_play', False))
